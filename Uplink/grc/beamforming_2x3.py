...
# Title: Beamforming 2X4
# Generated: Fri Jul 26 07:18:36 2024
##################################################
...
class beamforming_2x4(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Beamforming 2X4")
        ...
        self.uhd_usrp_source_0 = uhd.usrp_source(
        	",".join(("addr0= 192.168.10.6,addr1=192.168.10.2,addr2=192.168.10.5,addr3=192.168.10.4", "")),
        	uhd.stream_args(
        		cpu_format="fc32",
        		channels=range(3),
        	),
        ...
        self.uhd_usrp_sink_zf_tx = uhd.usrp_sink(
        	",".join(("addr0= 192.168.10.7,addr1=192.168.10.8", "")),
        	uhd.stream_args(
        		cpu_format="fc32",
        		channels=range(2),
        	),
        )
        self.uhd_usrp_sink_zf_tx.set_clock_rate(200e6, uhd.ALL_MBOARDS)
        self.uhd_usrp_sink_zf_tx.set_clock_source('external', 0)
        self.uhd_usrp_sink_zf_tx.set_time_source('external', 0)
        self.uhd_usrp_sink_zf_tx.set_clock_source('external', 1)
        self.uhd_usrp_sink_zf_tx.set_time_source('external', 1)
        self.uhd_usrp_sink_zf_tx.set_samp_rate(samp_rate)
        self.uhd_usrp_sink_zf_tx.set_time_unknown_pps(uhd.time_spec())
        self.uhd_usrp_sink_zf_tx.set_center_freq(frequency, 0)
        self.uhd_usrp_sink_zf_tx.set_gain(tx_gain, 0)
        self.uhd_usrp_sink_zf_tx.set_antenna('TX/RX', 0)
        self.uhd_usrp_sink_zf_tx.set_bandwidth(bw, 0)
        self.uhd_usrp_sink_zf_tx.set_center_freq(frequency, 1)
        self.uhd_usrp_sink_zf_tx.set_gain(tx_gain, 1)
        self.uhd_usrp_sink_zf_tx.set_antenna('TX/RX', 1)
        self.uhd_usrp_sink_zf_tx.set_bandwidth(bw, 1)
        ...
        self.blocks_file_sink_zf_rx3 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/kevin/Ruonan_WorkSpace/20240405-RSS-CE-Experiment/Experiment-Sec5-Evaluation/Experiment_Uplink_OurDesign/RAWDATA/USRP/Hydranet_LoRa/input/USRP_PostCoding_LoRa_RX3.dat', False)
        self.blocks_file_sink_zf_rx3.set_unbuffered(False)
        self.blocks_file_sink_zf_rx2 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/kevin/Ruonan_WorkSpace/20240405-RSS-CE-Experiment/Experiment-Sec5-Evaluation/Experiment_Uplink_OurDesign/RAWDATA/USRP/Hydranet_LoRa/input/USRP_PostCoding_LoRa_RX2.dat', False)
        self.blocks_file_sink_zf_rx2.set_unbuffered(False)
        self.blocks_file_sink_zf_rx1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/kevin/Ruonan_WorkSpace/20240405-RSS-CE-Experiment/Experiment-Sec5-Evaluation/Experiment_Uplink_OurDesign/RAWDATA/USRP/Hydranet_LoRa/input/USRP_PostCoding_LoRa_RX1.dat', False)
        ...
        self.connect((self.pfb_arb_resampler_ctrl_rx3, 0), (self.wxgui_fftsink2_0, 0))
        self.connect((self.pfb_arb_resampler_ctrl_tx1, 0), (self.uhd_usrp_sink_zf_tx, 0))
        self.connect((self.pfb_arb_resampler_ctrl_tx2, 0), (self.uhd_usrp_sink_zf_tx, 1))
    ...
    def set_bw(self, bw):
        ...
        self.uhd_usrp_sink_zf_tx.set_bandwidth(self.bw, 0)
        self.uhd_usrp_sink_zf_tx.set_bandwidth(self.bw, 1)
        self.uhd_usrp_sink_zf_tx.set_bandwidth(self.bw, 2)
        self.uhd_usrp_sink_zf_tx.set_bandwidth(self.bw, 3)
        self.uhd_usrp_sink_zf_tx.set_bandwidth(self.bw, 4)
        self.uhd_usrp_sink_zf_tx.set_bandwidth(self.bw, 5)
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.uhd_usrp_sink_zf_tx.set_gain(self.tx_gain, 0)

        self.uhd_usrp_sink_zf_tx.set_gain(self.tx_gain, 1)

        self.uhd_usrp_sink_zf_tx.set_gain(self.tx_gain, 2)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.uhd_usrp_sink_zf_tx.set_samp_rate(self.samp_rate)
        self.pfb_arb_resampler_ctrl_tx2.set_rate(self.samp_rate/self.bw)
        self.pfb_arb_resampler_ctrl_tx1.set_rate(self.samp_rate/self.bw)
        self.pfb_arb_resampler_ctrl_rx3.set_rate(self.bw/self.samp_rate)
        self.pfb_arb_resampler_ctrl_rx2.set_rate(self.bw/self.samp_rate)
    ...
    def set_frequency(self, frequency):
        ...
        self.uhd_usrp_sink_zf_tx.set_center_freq(self.frequency, 0)
        self.uhd_usrp_sink_zf_tx.set_center_freq(self.frequency, 1)
        self.uhd_usrp_sink_zf_tx.set_center_freq(self.frequency, 2)
        self.uhd_usrp_sink_zf_tx.set_center_freq(self.frequency, 3)
        self.uhd_usrp_sink_zf_tx.set_center_freq(self.frequency, 4)
        self.uhd_usrp_sink_zf_tx.set_center_freq(self.frequency, 5)


def main(top_block_cls=beamforming_2x4, options=None):
